...
sn.countplot(data=balanced_data)
...
def plot_word_cloud(data,typ):
    ...
    plt.title(f"Wordcloud fro {typ} emails",fontsize=15)
    plt.axis('off')
    plt.show()
...
hist=model.fit(train_sequences,train_Y,validation_data=(test_sequences,test_Y),epochs=5,batch_size=10,callbacks=[lr,es])
